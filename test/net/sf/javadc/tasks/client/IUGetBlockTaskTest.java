 ...
 */
public class IUGetBlockTaskTest extends AbstractClientTaskTest {

    public static void main(String[] args) {
        junit.textui.TestRunner.run(IUGetBlockTaskTest.class);
    }
    ...
    /**
     * Constructor for IUGetBlockTaskTest.
     * 
     * @param arg0
     */
    public IUGetBlockTaskTest(String arg0) {
        super(arg0);
    }
    ...
    public void runTask() {
        ...
        task = new IUGetBlockTask(shareManager, settings);
