 ...
 */
public class IUGetZBlockTaskTest extends AbstractClientTaskTest {

    public static void main(String[] args) {
        junit.textui.TestRunner.run(IUGetZBlockTaskTest.class);
    }
    ...
    /**
     * Constructor for IUGetZBlockTaskTest.
     * 
     * @param arg0
     */
    public IUGetZBlockTaskTest(String arg0) {
        super(arg0);
    }
    ...
    public void runTask() {
        ...
        task = new IUGetZBlockTask(shareManager, settings);
