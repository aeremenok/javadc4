...
/**
 * <CODE>StateChangedListener</CODE> is an <CODE>ActionListener</CODE>
 * implementation which flags the changed attribute of the related <CODE>
 * AbstractSettingsPanel</CODE> instance, when changes have occured
 * 
 * @author Timo Westk�mper
 */
public class StateChangedListener implements ActionListener {

    private final static Category logger = Category
            .getInstance(StateChangedListener.class);
     ...
     * @param panel
     */
    public StateChangedListener(AbstractSettingsPanel panel) {
        if (panel == null)
    ...
    public final void actionPerformed(ActionEvent e) {
        logger.debug("Settings changed to true for instance of "
                + panel.getClass());
...
/*******************************************************************************
 * $Log: StateChangedListener.java,v $
 * Revision 1.12  2005/10/02 11:42:28  timowest
 * updated sources and tests
 * Revision 1.11 2005/09/30 15:59:53
 * timowest updated sources and tests
 * 
 * Revision 1.10 2005/09/25 16:40:58 timowest updated sources and tests
 * 
