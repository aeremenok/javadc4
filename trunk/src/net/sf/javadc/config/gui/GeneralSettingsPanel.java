...
/**
 * <CODE>GeneralSettingsPanel</CODE> is a panel to edit general application
 * settings
 * 
...
public class GeneralSettingsPanel extends AbstractSettingsPanel {
    ...
    private final static Category logger = Category
            .getInstance(GeneralSettingsPanel.class);

    /**
     * 
     */
    private final String[] speeds = { "56Kbps", "Satellite", "DSL", "Cable",
            "LAN(T1)", "LAN(T3)" };
     ...
     */
    public GeneralSettingsPanel(ISettings _settings) {
        if (_settings == null)
    ...
    private JPanel getOtherSettingsPanel() {
        ...
        p1.setBorder(new TitledBorder(BorderFactory.createEtchedBorder(
                Color.white, new Color(148, 145, 140)), "Other Settings"));
    ...
    private final JPanel getUserSettingsPanel() {
        ...
        p1.setBorder(new TitledBorder(BorderFactory.createEtchedBorder(
                Color.white, new Color(148, 145, 140)), "User Settings"));
    ...
    public final void initPanel() {
        ...
        try {
            txtHubList.setText(settings.getAdvancedSettings()
                    .getHublistAddress());
        ...
        try {
            checkForceMove.setSelected(settings.getAdvancedSettings()
                    .isForceMove());
    ...
    public final void onOK() {
        ...
        settings.getAdvancedSettings()
                .setForceMove(checkForceMove.isSelected());
...
/*******************************************************************************
 * $Log: GeneralSettingsPanel.java,v $
