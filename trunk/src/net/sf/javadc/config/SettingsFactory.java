...
/**
 * <code>SettingsFactory</code> is used to create preconfigured Settings
 * instances, if the Settings can't be deserialized properly from the XML
 * representation
 * 
...
public class SettingsFactory {
    ...
    public ISettings createDefaultSettings() {
        ...
        advancedSettings
                .setHublistAddress("http://www.hublist.org/FullHubList.config.bz2");
...
/*******************************************************************************
 * $Log: SettingsFactory.java,v $
 * Revision 1.8  2005/10/02 11:42:27  timowest
 * updated sources and tests
 * Revision 1.7 2005/09/14 07:11:48 timowest
 * updated sources
 * 
 * 
 * 
