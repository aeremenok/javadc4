 ...
 */
public class User extends UserInfoAdapter {
    ...
    /**
     * Create a User instance with the given ISettings, IShareManager and
     * IHubManager
     * 
     * @param settings
     ...
     */
    public User(ISettings settings, IShareManager shareManager,
    ...
    /**
     * Return the DC++ related tag which encodes information about usage mode,
     * client version and download/upload slot usage
     * 
     * @return
     */
 ...
 * Revision 1.11 2005/09/30 15:59:52 timowest updated
 * sources and tests
 * 
