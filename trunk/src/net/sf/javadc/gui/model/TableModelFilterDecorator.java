...
/**
 * <CODE>TableModelFilterDecorator</CODE> is a light weight Decoratoe design
 * pattern implementation on top of the <CODE>TableModel</CODE> interface to
 * facilitate the implementation of filtering functionality
 * 
 * @author Timo Westk�mper
 */
public class TableModelFilterDecorator implements TableModel {
    ...
    /**
     * Create a TableModelFilterDecorator instance which wraps the given
     * TableModel
     * 
     * @param _model
     */
    public TableModelFilterDecorator(TableModel _model) {
        if (_model == null)
    ...
    /**
     * Create a TableModelFilterDecorator with the given filter on the given
     * column which wraps the given TableModel instance
     * 
     * @param _model
     * @param _filter
     * @param _column
     */
    public TableModelFilterDecorator(TableModel _model, String _filter,
            int _column) {
    ...
    public int getRowCount() {
        ...
        if (filterColumn == -1) { // filtering disabled
     ...
     * @param pattern
     */
    public void addFilter(int column, String pattern) {
...
/*******************************************************************************
 * $Log: TableModelFilterDecorator.java,v $
