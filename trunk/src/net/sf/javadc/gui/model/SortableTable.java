...
/**
 * <CODE>SortableTable</CODE> is a user interface component which uses a
 * <CODE>JTable</CODE> component to display the contents of an underlying
...
public class SortableTable extends JPanel {
    ...
    /**
     * Create a SortableTable instance with the given column lengths, a
     * SortableTableListener and a TableModel
     * 
     * @param cols
     * @param listener
     * @param m
     */
    public SortableTable(int[] cols, SortableTableListener listener,
            TableModel m) {
    ...
    /**
     * Create a SortableTable instance with the given column lengths, a
     * SortableTableListener, a TableModel and the count text
     * 
     * @param cols
     * @param listener
     * @param m
     ...
     */
    public SortableTable(int[] cols, SortableTableListener listener,
            TableModel m, String _countText) {
        ...
        table.addComponentListener(new MyComponentAdapter(table, scrollPane,
                columnWidths));
        ...
        toolTipHandler = new TableToolTipHandler() {
            ...
            public String getToolTipText(int row, int column, Object o) {
     ...
     * @param listener
     */
    public final void addListener(SortableTableListener listener) {
    ...
    /**
     * Notify registered listeners that the cell with the given row and column
     * index has been selected
     * 
     * @param row
     * @param column
     */
    private final void fireCellSelected(int row, int column) {
        SortableTableListener[] listeners = (SortableTableListener[]) listenerList
                .getListeners(SortableTableListener.class);
    ...
    /**
     * Notify registered listeners that a popup for the cell with the given row
     * and column index is shown
     * 
     * @param row
     * @param column
     * @param e
     */
    private final void fireShowPopup(int row, int column, MouseEvent e) {
        SortableTableListener[] listeners = (SortableTableListener[]) listenerList
                .getListeners(SortableTableListener.class);
     ...
     * @return
     */
    private final int getRealRow(int row) {
     ...
     * @param tth
     */
    public final void setToolTipHandler(TableToolTipHandler tth) {
     ...
     * 
     * @param column
     *            index of the column the model is to be sorted by
     * @param ascending
     *            whether the sorting is to be ascending or descending
     */
    public final void sortByColumn(int column, boolean ascending) {
    ...
    private final class MyComponentAdapter extends ComponentAdapter {
        ...
        private MyComponentAdapter(JTable table, JScrollPane scrollPane,
                int[] columnWidths) {
            super();
            this.table = table;
        ...
        public void componentResized(ComponentEvent e) {
            if (lastWidth == -1) {
                ...
                if (restColumn != -1) {
                    table.getColumnModel().getColumn(restColumn)
                            .setPreferredWidth(rest);
    ...
    private final class MyJTable extends JTable {
        ...
        private MyJTable(TableModel arg0) {
            super(arg0);
        ...
        public String getToolTipText(MouseEvent e) {
            ...
            int column = table.convertColumnIndexToModel(table.getColumnModel()
                    .getColumnIndexAtX(e.getX()));

            return toolTipHandler.getToolTipText(row, column, (Object) table
                    .getValueAt(table.rowAtPoint(e.getPoint()), column));
...
/*******************************************************************************
 * $Log: SortableTable.java,v $
 * Revision 1.16  2005/10/02 11:42:28  timowest
 * updated sources and tests
 * Revision 1.15 2005/09/26 17:19:52 timowest
 * updated sources and tests
 * 
 * Revision 1.14 2005/09/15 17:32:29 timowest added null checks
 * 
