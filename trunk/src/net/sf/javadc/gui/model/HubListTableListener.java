...
public class HubListTableListener
    implements
        SortableTableListener
{
    ...
    /**
     * Create a HubListTableListener with the given RowTableModel, IHubList instance, IHubFavoritesList instance and
     * IHubFactory instance
     * 
     * @param _model RowTableModel to be used
     * @param _favoritesList IHubFavoritesList instance to be used
     * @param _hubFactory IHubFacotry instance to be used
     */
    public HubListTableListener(
...
/*******************************************************************************
 * $Log: HubListTableListener.java,v $ Revision 1.11 2005/10/02 11:42:28 timowest updated sources and tests Revision
 * 1.10 2005/09/15 17:32:29 timowest added null checks Revision 1.9 2005/09/14 07:11:49 timowest updated sources
 */
