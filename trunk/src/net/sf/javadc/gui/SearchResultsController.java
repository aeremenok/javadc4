...
public class SearchResultsController implements SortableTableListener {
    ...
    /**
     * Create a SearchResultsController with the given IHub, ISettings and
     * RowTableModel
     * 
     * @param _hub
     ...
     */
    public SearchResultsController(IHub _hub, ISettings _settings,
            IDownloadManager _downloadManager, RowTableModel _model) {
    ...
    public final void cellSelected(int row, int column, int[] selectedRows) {
        ...
        for (int i = 0; i < selectedRows.length; i++) {
            ...
            downloadManager.requestDownload(new DownloadRequest(
                    (SearchResult) model.getRow(selectedRows[i]), settings));
    ...
    public final void showPopupClicked(final int row, final int column,
        ...
        DownloadResumePopupMenu popup = new DownloadResumePopupMenu(hub,
                (SearchResult) model.getRow(row), searchResults, settings,
                downloadManager);
...
/*******************************************************************************
 * $Log: SearchResultsController.java,v $
 * Revision 1.13  2005/10/02 11:42:28  timowest
 * updated sources and tests
 * Revision 1.12 2005/09/14 07:11:49
