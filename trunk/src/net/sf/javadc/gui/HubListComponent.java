        ...
        final IHubFactory _hubFactory )
    {
        ...
        hubFavoritesList.addListener( (HubListListener) Spin.over( new HubListListener()
        {
            ...
            public void hubListChanged()
            {
                ...
                if ( h != null )
                {
                    hubInfos = (IHubInfo[]) h.toArray( new IHubInfo[h.size()] );
...
/*******************************************************************************
 * $Log: HubListComponent.java,v $ Revision 1.24 2005/10/02 11:42:28 timowest updated sources and tests Revision 1.23
