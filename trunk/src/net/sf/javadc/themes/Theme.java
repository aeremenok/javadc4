...
/**
 * Created by IntelliJ IDEA. User: interactif06 Date: 3-ago-2004 Time: 16.58.00 To change this template use File |
...
public interface Theme
{
     ...
     * @see #isConfigurable()
     */
    boolean showConfigurationDialog(
        Component parent );

}

/*******************************************************************************
 * $Log: Theme.java,v $ Revision 1.7 2005/10/02 11:42:28 timowest updated sources and tests Revision 1.6 2005/09/14
