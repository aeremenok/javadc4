 ...
 */
public class SDisconnectTask extends BaseClientTask {

    private static final Category logger = Category
            .getInstance(SDisconnectTask.class);
     ...
     */
    public SDisconnectTask(ITaskManager _taskManager) {
    ...
    protected final void runTaskTemplate() {
        PerformanceContext cont = new PerformanceContext(
                "SDisconnectTask#runTaskTemplate").start();
        ...
        taskManager.removeTask((Connection) clientConnection);
