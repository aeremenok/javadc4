 ...
 * 
 * <p>
 * $UGetBlock follows $UGetZBlock semantics, but without compressing the data.
 * The bytes parameter of $Sending specifies how many bytes will be sent.
 * </p>
 * 
 * @author Timo Westk�mper
 */
public class IUGetBlockTask extends BaseClientTask {

    private static final Category logger = Category
            .getInstance(IUGetBlockTask.class);
     ...
     */
    public IUGetBlockTask(IShareManager _shareManager, ISettings _settings) {
    ...
    protected void runTaskTemplate() {
        ...
        if (settings.reserveUploadSlot() && (fileOffset > -1)) {
            ...
            if ((local == null) || !local.isFile()) {
                ...
                throw new ClientTaskException("The required file " + filename
                        + " was " + ((local == null) ? "null" : "invalid"));
