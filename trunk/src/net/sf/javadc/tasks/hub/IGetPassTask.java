...
/**
 * <CODE>IGetPassTask</CODE> is called when specified nickname is registered and the hub asks for a password
 * 
 * @author tw70794
 */
public class IGetPassTask
    extends BaseHubTask
{
    ...
    protected void runTaskTemplate()
    {
        ...
        String passwd = javax.swing.JOptionPane.showInputDialog( null, "Please enter your password: " );
