 ...
 * <p>
 * only if the connecting user provide the Hub with a password that didn't match the password under his nickname in the
 * Hub's registry of users.
 * </p>
 * 
 * @author tw70794
 */
public class IBadPassTask
    extends BaseHubTask
{

    private static final Category logger = Category.getInstance( IBadPassTask.class );
