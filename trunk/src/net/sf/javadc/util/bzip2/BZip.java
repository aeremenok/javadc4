...
public final class BZip {
     ...
     * 
     * @param infile
     *            The <code>File</code> to decompress.
     * @param outfile
     *            The decompressed <code>File</code>.
     */
    public final static void decompress(File infile, File outfile) {
     ...
     *            Description of the Parameter
     */
    public final static void compress(File infile, File outfile, int blockSize) {
     ...
     * 
     * @param infile
     *            A <code>String</code> containig the Name of the File to
     *            decompress.
     * @param outfile
     *            A <code>String</code> containig the Name of the decompressed
     *            File.
     * @param prog
     *            The ProgressListener, that listens to the progress.
     */
    public final static void decompress(String infilename, String outfilename,
     ...
     *            Description of the Parameter
     */
    public final static void decompress(InputStream instream, File outfile,
            ProgressListener prog) {
     ...
     *            Description of the Parameter
     */
    public final static void decompress(File infile, OutputStream outstream,
            ProgressListener prog) {
     ...
     *            Description of the Parameter
     */
    public final static void decompress(InputStream instream,
            OutputStream outstream, ProgressListener prog) {
     ...
     */
    public final static boolean test(String infilename) {
        final File theinFile = new File(infilename);
     ...
     * @return Description of the Return Value
     */
    public final static boolean test(File infile) {
        try {
            final FileInputStream fis = new FileInputStream(infile);
    ...
    public final static void compress(String infilename, String outfilename,
            int blockSize, ProgressListener prog) {
     ...
     *            Description of the Parameter
     */
    public final static void compress(InputStream instream, File outfile,
            int blockSize, ProgressListener prog) {
        try {
            final FileOutputStream fos = new FileOutputStream(outfile);
     ...
     *            Description of the Parameter
     */
    public final static void compress(File infile, OutputStream outstream,
            int blockSize, ProgressListener prog) {
        try {
            final FileInputStream fis = new FileInputStream(infile);
     ...
     *            Description of the Parameter
     */
    public final static void compress(InputStream instream,
            OutputStream outstream, int blockSize, ProgressListener prog) {
