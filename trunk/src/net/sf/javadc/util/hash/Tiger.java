 ...
 * block of a digested message must include a required padding byte which must
 * be 0x01, the remaining padding bytes must be set to 0x00.
 * 
 * May be in the future, this class will be part of the standard JCE (Java
 * Cryptography Environment) included in Java 1.5, code named... Tiger! For now
 * Java 1.4, code named Merlin, does not have this digest algorithm, and only
 * includes Adler32 or CRC32 (in java.util.zip), and MD4, MD5 or SHA1 (in
 * javax.crypto.Mac, included in the SUN JCE).
 */
public final class Tiger extends MessageDigest implements Cloneable {
    ...
    /**
     * Private context for incomplete blocks and padding bytes. INVARIANT:
     * padding must be in 0..63. When the padding reaches 64, a new block is
     * computed, and the 56 last bytes are kept in the padding history.
     */
    private byte[] pad;
    ...
    /**
     * Private Contextual byte count, send in the next block, after the ending
     * padding block.
     */
    private long bytes;
     ...
     * padding. Computes the final hash and returns the final value as a
     * byte[24] array. Once engineDigest has been called, the engine will be
     * automatically reset as specified in the JavaSecurity MessageDigest
     * specification.
     * 
     * For faster operations with multiple digests, allocate your own array and
     * use engineDigest(byte[], int offset, int len). * Overrides the protected
    ...
    private void computeBlock(final byte[] input, int offset) {
        ...
        a = (hA - (S0[(lo = (int) c) & 0xff] ^ S1[(lo >>> 16) & 0xff]
                ...
                ^ (w1 = ((long) ((input[offset + 3] & 0xff)
                        ...
                        | ((input[offset += 5] & 0xff) << 16) | (input[offset + 1] << 24)) & 0xffffffffL)
                        | ((long) ((input[offset + 2] & 0xff)
                                | ((input[offset + 3] & 0xff) << 8)
                                | ((input[offset + 4] & 0xff) << 16) | (input[offset += 5] << 24)) << 32));
        b = (((S3[(lo >>> 8) & 0xff] ^ S2[lo >>> 24] ^ S1[(hi >>> 8) & 0xff] ^ S0[hi >>> 24]) + hB) * 5 - (S0[(lo = (int) a) & 0xff]
                ^ S1[(lo >>> 16) & 0xff] ^ S2[(hi = (int) (a >>> 32)) & 0xff] ^ S3[(hi >>> 16) & 0xff]))
                ^ (w2 = ((long) ((input[offset + 1] & 0xff)
                        | ((input[offset + 2] & 0xff) << 8)
                        | ((input[offset + 3] & 0xff) << 16) | (input[offset + 4] << 24)) & 0xffffffffL)
                        | ((long) ((input[offset += 5] & 0xff)
                                | ((input[offset + 1] & 0xff) << 8)
                                | ((input[offset + 2] & 0xff) << 16) | (input[offset + 3] << 24)) << 32));
        c = (((S3[(lo >>> 8) & 0xff] ^ S2[lo >>> 24] ^ S1[(hi >>> 8) & 0xff] ^ S0[hi >>> 24]) + c) * 5 - (S0[(lo = (int) b) & 0xff]
                ^ S1[(lo >>> 16) & 0xff] ^ S2[(hi = (int) (b >>> 32)) & 0xff] ^ S3[(hi >>> 16) & 0xff]))
                ^ (w3 = ((long) ((input[offset + 4] & 0xff)
                        | ((input[offset += 5] & 0xff) << 8)
                        | ((input[offset + 1] & 0xff) << 16) | (input[offset + 2] << 24)) & 0xffffffffL)
                        | ((long) ((input[offset + 3] & 0xff)
                                | ((input[offset + 4] & 0xff) << 8)
                                | ((input[offset += 5] & 0xff) << 16) | (input[offset + 1] << 24)) << 32));
        a = (((S3[(lo >>> 8) & 0xff] ^ S2[lo >>> 24] ^ S1[(hi >>> 8) & 0xff] ^ S0[hi >>> 24]) + a) * 5 - (S0[(lo = (int) c) & 0xff]
                ^ S1[(lo >>> 16) & 0xff] ^ S2[(hi = (int) (c >>> 32)) & 0xff] ^ S3[(hi >>> 16) & 0xff]))
                ^ (w4 = ((long) ((input[offset + 2] & 0xff)
                        | ((input[offset + 3] & 0xff) << 8)
                        | ((input[offset + 4] & 0xff) << 16) | (input[offset += 5] << 24)) & 0xffffffffL)
                        | ((long) ((input[offset + 1] & 0xff)
                                | ((input[offset + 2] & 0xff) << 8)
                                | ((input[offset + 3] & 0xff) << 16) | (input[offset + 4] << 24)) << 32));
        b = (((S3[(lo >>> 8) & 0xff] ^ S2[lo >>> 24] ^ S1[(hi >>> 8) & 0xff] ^ S0[hi >>> 24]) + b) * 5 - (S0[(lo = (int) a) & 0xff]
                ^ S1[(lo >>> 16) & 0xff] ^ S2[(hi = (int) (a >>> 32)) & 0xff] ^ S3[(hi >>> 16) & 0xff]))
        ...
        a = (((S3[(lo >>> 8) & 0xff] ^ S2[lo >>> 24] ^ S1[(hi >>> 8) & 0xff] ^ S0[hi >>> 24]) + a) * 5 - (S0[(lo = (int) c) & 0xff]
                ...
                ^ (w7 = ((long) ((input[offset + 1] & 0xff)
                        ...
                        | ((long) ((input[offset += 5] & 0xff)
                                | ((input[offset + 1] & 0xff) << 8)
                                | ((input[offset + 2] & 0xff) << 16) | (input[offset + 3] << 24)) << 32));
        b = ((S3[(lo >>> 8) & 0xff] ^ S2[lo >>> 24] ^ S1[(hi >>> 8) & 0xff] ^ S0[hi >>> 24]) + b)
                * 5
        ...
        w7 ^= w6 -= (w5 += w4 ^= w3 -= (w2 += w1 ^= w0 -= w7 ^ 0xa5a5a5a5a5a5a5a5L)
                ^ ((~w1) << 19))
                ^ ((~w4) >>> 23);
        /* Second pass on scheduled input, with multiplier equal to 7. */
        c = (c - (S0[(lo = (int) (b ^= w0 += w7)) & 0xff]
                ^ S1[(lo >>> 16) & 0xff] ^ S2[(hi = (int) (b >>> 32)) & 0xff] ^ S3[(hi >>> 16) & 0xff]))
                ^ (w1 -= (w0) ^ ((~w7) << 19));
        a = (((S3[(lo >>> 8) & 0xff] ^ S2[lo >>> 24] ^ S1[(hi >>> 8) & 0xff] ^ S0[hi >>> 24]) + a) * 7 - (S0[(lo = (int) c) & 0xff]
                ^ S1[(lo >>> 16) & 0xff] ^ S2[(hi = (int) (c >>> 32)) & 0xff] ^ S3[(hi >>> 16) & 0xff]))
                ^ (w2 ^= w1);
        b = (((S3[(lo >>> 8) & 0xff] ^ S2[lo >>> 24] ^ S1[(hi >>> 8) & 0xff] ^ S0[hi >>> 24]) + b) * 7 - (S0[(lo = (int) a) & 0xff]
                ^ S1[(lo >>> 16) & 0xff] ^ S2[(hi = (int) (a >>> 32)) & 0xff] ^ S3[(hi >>> 16) & 0xff]))
                ^ (w3 += w2);
        c = (((S3[(lo >>> 8) & 0xff] ^ S2[lo >>> 24] ^ S1[(hi >>> 8) & 0xff] ^ S0[hi >>> 24]) + c) * 7 - (S0[(lo = (int) b) & 0xff]
                ^ S1[(lo >>> 16) & 0xff] ^ S2[(hi = (int) (b >>> 32)) & 0xff] ^ S3[(hi >>> 16) & 0xff]))
                ^ (w4 -= w3 ^ ((~w2) >>> 23));
        a = (((S3[(lo >>> 8) & 0xff] ^ S2[lo >>> 24] ^ S1[(hi >>> 8) & 0xff] ^ S0[hi >>> 24]) + a) * 7 - (S0[(lo = (int) c) & 0xff]
                ^ S1[(lo >>> 16) & 0xff] ^ S2[(hi = (int) (c >>> 32)) & 0xff] ^ S3[(hi >>> 16) & 0xff]))
        ...
        a = ((S3[(lo >>> 8) & 0xff] ^ S2[lo >>> 24] ^ S1[(hi >>> 8) & 0xff] ^ S0[hi >>> 24]) + a)
                * 7
         ...
         * with this schedule.
         */
        b = (b - (S0[(lo = (int) (a ^= w0 += w7)) & 0xff]
                ^ S1[(lo >>> 16) & 0xff] ^ S2[(hi = (int) (a >>> 32)) & 0xff] ^ S3[(hi >>> 16) & 0xff]))
                ^ (w1 -= w0 ^ ((~w7) << 19));
        c = (((S3[(lo >>> 8) & 0xff] ^ S2[lo >>> 24] ^ S1[(hi >>> 8) & 0xff] ^ S0[hi >>> 24]) + c) * 9 - (S0[(lo = (int) b) & 0xff]
                ^ S1[(lo >>> 16) & 0xff] ^ S2[(hi = (int) (b >>> 32)) & 0xff] ^ S3[(hi >>> 16) & 0xff]))
                ^ (w2 ^= w1);
        a = (((S3[(lo >>> 8) & 0xff] ^ S2[lo >>> 24] ^ S1[(hi >>> 8) & 0xff] ^ S0[hi >>> 24]) + a) * 9 - (S0[(lo = (int) c) & 0xff]
                ^ S1[(lo >>> 16) & 0xff] ^ S2[(hi = (int) (c >>> 32)) & 0xff] ^ S3[(hi >>> 16) & 0xff]))
                ^ (w3 += w2);
        b = (((S3[(lo >>> 8) & 0xff] ^ S2[lo >>> 24] ^ S1[(hi >>> 8) & 0xff] ^ S0[hi >>> 24]) + b) * 9 - (S0[(lo = (int) a) & 0xff]
                ^ S1[(lo >>> 16) & 0xff] ^ S2[(hi = (int) (a >>> 32)) & 0xff] ^ S3[(hi >>> 16) & 0xff]))
                ^ (w4 -= w3 ^ ((~w2) >>> 23));
        c = (((S3[(lo >>> 8) & 0xff] ^ S2[lo >>> 24] ^ S1[(hi >>> 8) & 0xff] ^ S0[hi >>> 24]) + c) * 9 - (S0[(lo = (int) b) & 0xff]
                ^ S1[(lo >>> 16) & 0xff] ^ S2[(hi = (int) (b >>> 32)) & 0xff] ^ S3[(hi >>> 16) & 0xff]))
        ...
        hB = (b = (((S3[(lo >>> 8) & 0xff] ^ S2[lo >>> 24]
                ^ S1[(hi >>> 8) & 0xff] ^ S0[hi >>> 24]) + b) * 9 - (S0[(lo = (int) a) & 0xff]
                ^ S1[(lo >>> 16) & 0xff] ^ S2[(hi = (int) (a >>> 32)) & 0xff] ^ S3[(hi >>> 16) & 0xff]))
                ^ (w7 - (w6 ^ 0x0123456789abcdefL)))
                - hB;
        hC += ((S3[(lo >>> 8) & 0xff] ^ S2[lo >>> 24] ^ S1[(hi >>> 8) & 0xff] ^ S0[hi >>> 24]) + c)
                * 9
    ...
    /**
     * Precomputed constant Tiger "S-Boxes" in 64-bit format. Each of these four
     * table have 256 elements.
     */
