...
/**
 * <code>ClientListenerBase</code> is the default implementation of the <code>ClientListener</code> interface. It can be
 * used as the super class for implementations which are only interested in few notifications.
 * 
 * @author Jesper Nordenberg
 * @version $Revision: 1.11 $ $Date: 2005/10/02 11:42:27 $
 */
public class ClientListenerBase
    implements
        ClientListener
{
    /*
     ...
     */
    public void browseListDownloaded(
        IClient client,
        DownloadRequest sr,
        HostInfo host )
    {
