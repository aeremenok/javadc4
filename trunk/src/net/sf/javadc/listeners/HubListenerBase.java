...
/**
 * <code>HubListenerBase</code> is the default implementation of the
 * <code>HubListener</code> interface. It can be used as the super class for
 * implementations which are only interested in few notifications.
 * 
 * @author Jesper Nordenberg
 * @version $Revision: 1.8 $ $Date: 2005/10/02 11:42:27 $
 */
public class HubListenerBase implements HubListener {
     ...
     */
    public void gotMessage(IHub hub, Message message) {
     ...
     *      net.sf.javadc.net.Message)
     */
    public void gotUserMessage(IHub hub, Message message) {
     ...
     */
    public void searchResultsCleared(IHub hub) {
     ...
     */
    public void searchResultAdded(IHub hub, SearchResult sr, SearchRequest sre) {
     ...
     *      net.sf.javadc.net.hub.HubUser)
     */
    public void browseListDecoded(IHub hub, HubUser ui) {
