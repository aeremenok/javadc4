...
/**
 * <code>ClientManagerListener</code> is the listener interface for objects interested in notifications from
 * <code>ClientManager</code> instances
 * 
        ...
        EventListener
{
     ...
     * 
     * @param client Client instance which has been added
     */
    void clientAdded(
        Client client );
     ...
     * 
     * @param client Client instance which has been removed
     */
    void clientRemoved(
        IClient client );
