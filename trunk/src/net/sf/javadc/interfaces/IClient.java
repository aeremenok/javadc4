...
public interface IClient
{
     ...
     * @throws IOException
     */
    public abstract void addDownload(
        DownloadRequest dr )
        throws IOException;
     ...
     * @throws IOException
     */
    public abstract void addDownloads(
        DownloadRequest[] drs )
        throws IOException;
     ...
     * @throws IOException
     */
    public abstract void checkDownloads()
        throws IOException;
     ...
     * @return
     */
    public abstract DownloadRequest getDownload(
        int index );
     ...
     */
    public abstract void removeDownload(
        DownloadRequest dr );
     ...
     * @param b
     */
    public abstract void setBZSupport(
        boolean b );
