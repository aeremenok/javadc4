 ...
 * @author twe
 */
public class HubSRTask implements ITask {

    private static final Category logger = Category
            .getInstance(HubSRTask.class);
    ...
    /**
     * Create a HubSRTask instance with the given IHubManager, IHubTaskFactory,
     * search result and hub IP
     * 
     * @param _hubManager
     ...
     * @param _result
     *            search result to be used
     * @param _hubIP
     *            hub ip to be used
     */
    public HubSRTask(IHubManager _hubManager, IHubTaskFactory _hubTaskFactory,
            String _result, String _hubIP) {
...
/*******************************************************************************
 * $Log$
 * Revision 1.5  2005/10/02 11:42:27  timowest
 * updated sources and tests
 * Revision 1.4 2005/09/30 15:59:53 timowest updated sources and tests
 * 
 * Revision 1.3 2005/09/15 17:31:54 timowest updated HubSRTask
 * 
 * Revision 1.2 2005/09/12 21:12:02 timowest added log block
 * 
 * 
 */
