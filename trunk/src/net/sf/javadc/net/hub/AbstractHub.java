...
/**
 * <code>AbstractHub</code> represents an abstract base implementation for the
 * <code>IHub</code> interface mainly used to separate the listener
 * notification code from the main implementation
 * 
 * @author Timo Westk�mper
 */
public abstract class AbstractHub extends GenericModel implements IHub {
     ...
     */
    public final void fireBrowseListDecoded(HubUser ui) {
        final HubListener[] l = (HubListener[]) listenerList
     ...
     */
    public final void fireGotMessage(Message msg) {
        final HubListener[] l = (HubListener[]) listenerList
                .getListeners(HubListener.class);
     ...
     */
    public final void fireGotUserMessage(Message msg) {
        final HubListener[] l = (HubListener[]) listenerList
                .getListeners(HubListener.class);
     ...
     */
    public final void fireSearchResultAdded(SearchResult sr,
    ...
    public final void fireSearchResultsCleared() {
        ...
        for (int i = 0; i < l.length; i++) {
            l[i].searchResultsCleared((IHub) this);
     ...
     */
    public final void fireUserAdded(HubUser ui) {
        final HubListener[] l = (HubListener[]) listenerList
                .getListeners(HubListener.class);
     ...
     */
    public final void fireUserRemoved(HubUser ui) {
        final HubListener[] l = (HubListener[]) listenerList
                .getListeners(HubListener.class);
...
/*******************************************************************************
 * $Log: AbstractHub.java,v $
 * Revision 1.10  2005/10/02 11:42:28  timowest
 * updated sources and tests
 * Revision 1.9 2005/09/12 21:12:02 timowest added
 * log block
 * 
 * 
 */
