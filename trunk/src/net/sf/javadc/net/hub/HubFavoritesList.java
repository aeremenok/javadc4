...
/**
 * <code>HubFavoritesList</code> reprsents the list of favorite Hubs which can
 * be assembled and extended via the user interface. The serialization and
 * deserialization is accomplised via a <code>HubFavoritesLoader</code>
 * instance.
 * 
 * @author Timo Westk�mper
 */
public class HubFavoritesList extends GenericModel implements Startable,
        IHubFavoritesList {
     ...
     */
    public HubFavoritesList(IHubFavoritesLoader _loader) {
    ...
    private final void fireHubListChanged() {
        final HubListListener[] listeners = (HubListListener[]) listenerList
                .getListeners(HubListListener.class);
     ...
     */
    public final void addHubInfo(IHubInfo hubInfo) {
        if (hubInfo == null) {
            throw new NullPointerException("hubInfo was null.");

        }

        if (!hubInfos.contains(hubInfo)) { // if hub has not yet been added
     ...
     */
    public final void removeHub(IHubInfo hubInfo) {
        if (hubInfo == null) {
            throw new NullPointerException("hubInfo was null.");
