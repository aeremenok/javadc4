...
public class HostInfo {
     ...
     * </CODE> representing the host and port of the hub or remote client
     */
    public HostInfo(String hostAndPort) {
        ...
        if (elements.length > 1) {
            setPort(SafeParser.parseInt(elements[1],
                    ConstantSettings.DEFAULT_PORT));

            // string includes alternate host address
            if (elements.length > 2) {
                this.alternatePort = SafeParser.parseInt(elements[2],
                        ConstantSettings.DEFAULT_PORT);
     ...
     */
    public final String getIpString() throws UnknownHostException {
 ...
 * sources and tests
 * 
 * Revision 1.12 2005/09/26 17:19:52 timowest updated sources and tests
 * 
 * Revision 1.11 2005/09/15 17:37:14 timowest updated sources and tests
 * 
