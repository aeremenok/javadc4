...
public class SafeInputStream extends InputStream {
     ...
     * @param is
     */
    public SafeInputStream(InputStream is) {
     ...
     * @return
     */
    protected int transform(int ch) {
        if (ch < 32)
            return 32;
...
/*******************************************************************************
 * $Log: SafeInputStream.java,v $
 * Revision 1.8  2005/10/02 11:42:28  timowest
 * updated sources and tests
 * Revision 1.7 2005/09/30 15:59:53 timowest
 * updated sources and tests
 * 
 * Revision 1.6 2005/09/26 17:19:52 timowest updated sources and tests
 * 
