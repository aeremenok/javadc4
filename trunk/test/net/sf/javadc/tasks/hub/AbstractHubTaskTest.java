...
public abstract class AbstractHubTaskTest extends TestCase {
    ...
    protected static final Category logger = Category
            .getInstance(AbstractHubTaskTest.class);
    ...
    protected final IHubFactory hubFactory = new HubFactory(taskManager,
            hubManager, hubTaskFactory, settings);
