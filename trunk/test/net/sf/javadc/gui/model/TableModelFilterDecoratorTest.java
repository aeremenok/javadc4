...
public class TableModelFilterDecoratorTest extends TestCase {
    ...
    private String[][] content = { { "aAa", "bbb", "ccc" },
            { "AAB", "bbc", "cccd" }, { "abc", "abc", "abc" } };

    private TableModel tableModel = new MyTableModel(content);

    private TableModelFilterDecorator filteredTableModel = new TableModelFilterDecorator(
            tableModel);
    ...
    public void testBasic() throws Exception {
        ...
        assertEquals(tableModel.getValueAt(0, 0), filteredTableModel
                .getValueAt(0, 0));
    }
