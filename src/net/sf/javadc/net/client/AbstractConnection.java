...
/**
 * <code>AbstractConnection</code> represents an abstract base implementation
 * for the <code>IConnection</code> interface mainly used to separate the
 * listener notification code from the main implementation
 * 
 * @author Timo Westk�mper
 */
public abstract class AbstractConnection extends GenericModel implements
        IConnection {
    ...
    public final void fireDownloadComplete() {
        ConnectionListener[] l = (ConnectionListener[]) listenerList
 ...
 * Revision 1.15 2005/09/12 21:12:02 timowest
 * added log block
 * 
 * 
 */
