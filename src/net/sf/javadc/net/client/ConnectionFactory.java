...
/**
 * <code>ConnectionFactory</code> represents a factory method implementation
 * for the creation of <code>Connection</code> instances.
 * 
...
public class ConnectionFactory implements IConnectionFactory {
     ...
     */
    public ConnectionFactory(ITaskManager _taskManager,
     ...
     */
    public final IConnection createClientConnection(Client client,
        ...
        if (clientConnectionManager.getConnectionCount() == ConnectionSettings.MAX_CONNECTION_COUNT) {
            logger.debug("No more connections can be created. Maximum of "
                    + ConnectionSettings.MAX_CONNECTION_COUNT
                    + " has been reached.");
        ...
        try {
            conn = new Connection(client, listener, isServer, taskManager,
                    clientConnectionManager, clientManager, clientTaskFactory);
        ...
        if (clientConnectionManager.contains(conn)) {
            ...
            String debug = "Connection was already available in "
                    + "ConnectionManager.";
            logger.debug(debug);
...
/*******************************************************************************
 * $Log: ConnectionFactory.java,v $
 * Revision 1.17  2005/10/02 11:42:28  timowest
 * updated sources and tests
 * Revision 1.16 2005/09/30 15:59:53 timowest
 * updated sources and tests
 * 
