...
/**
 * <CODE>ClientConnectionState</CODE> represents the different states of a
...
public class ConnectionState extends Enum {
     ...
     * 
     */
    public final static ConnectionState COMMAND_DOWNLOAD = new ConnectionState(
            "Idle download mode");

    /**
     * 
     */
    public final static ConnectionState COMMAND_UPLOAD = new ConnectionState(
            "Idle upload mode");
     ...
     * 
     */
    public final static ConnectionState CONNECTING = new ConnectionState(
            "Connecting");

    /**
     * 
     */
    public final static ConnectionState NOT_CONNECTED = new ConnectionState(
            "Not connected");
     ...
     * 
     */
    public final static ConnectionState SETTING_DIRECTION = new ConnectionState(
            "Setting direction");
     ...
     * 
     */
    public final static ConnectionState DOWNLOADING = new ConnectionState(
            "Downloading");

    /**
     * 
     */
    public final static ConnectionState RESUMING = new ConnectionState(
            "Resuming");

    /**
     * 
     */
    public final static ConnectionState RESUME_SUCCEEDED = new ConnectionState(
            "Resume succeeded.");

    /**
     * 
     */
    public final static ConnectionState UPLOADING = new ConnectionState(
            "Uploading");

    /**
     * 
     */
    public final static ConnectionState COMPRESSED_UPLOADING = new ConnectionState(
            "Uploading (compressed)");

    /**
     * 
     */
    public final static ConnectionState DOWNLOAD_FINISHED = new ConnectionState(
            "Download finished");

    /**
     * 
     */
    public final static ConnectionState UPLOAD_FINISHED = new ConnectionState(
            "Upload finished");
     ...
     * 
     */
    public final static ConnectionState REMOTELY_QUEUED = new ConnectionState(
            "Remotely Queued");

    /**
     * 
     */
    public final static ConnectionState NO_UPLOAD_SLOTS = new ConnectionState(
            "No Upload slots");

    /**
     * 
     */
    public final static ConnectionState NO_DOWNLOAD_SLOTS = new ConnectionState(
            "No Download slots");
     ...
     * 
     */
    public final static ConnectionState RESUME_FAILED = new ConnectionState(
            "Resume failed.");

    /**
     * 
     */
    public final static ConnectionState CORRUPT_FILE = new ConnectionState(
            "Corrupt File");

    /**
     * 
     */
    public final static ConnectionState INVALID_LOCK = new ConnectionState(
            "Invalid Lock Data");

    /**
     * 
     */
    public final static ConnectionState INVALID_DIRECTION = new ConnectionState(
            "Invalid Direction Data");

    /**
     * 
     */
    public final static ConnectionState FILE_NOT_FOUND = new ConnectionState(
            "File Not Found.");
     ...
     * 
     * @param state
     *            ConnectionState for which the task name should be retrieved
     * @return taskName that can be used to query a ClientTask from the
     *         ClientTaskFactory
     */
    public static String getTransition(ConnectionState state) {
...
/*******************************************************************************
 * $Log: ConnectionState.java,v $
 * Revision 1.16  2005/10/02 11:42:28  timowest
 * updated sources and tests
 * Revision 1.15 2005/09/30 15:59:53 timowest
 * updated sources and tests
 * 
