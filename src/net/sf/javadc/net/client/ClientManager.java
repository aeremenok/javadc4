...
/**
 * <code>ClientManager</code> represents a main networking components, which
 * keeps track of the active <code>Client</code> instances and creates new
 * ones when requested
 * 
 * @author Jesper Nordenberg
 * @version $Revision: 1.19 $ $Date: 2005/10/02 11:42:28 $
 */
public class ClientManager extends GenericModel implements IClientManager {
     ...
     * </CODE>,<CODE>ITaskManager</CODE>,<CODE>IClientConnectionManager
     * </CODE> and <CODE>ClientTaskFactory</CODE>
     */
    public ClientManager(ISettings _settings, ITaskManager _taskManager,
     ...
     */
    public final Client getClient(HostInfo host) {
     ...
     */
    public final void fireClientAdded(Client c) {
        ClientManagerListener[] listeners = (ClientManagerListener[]) listenerList
                .getListeners(ClientManagerListener.class);
     ...
     */
    public final void fireClientRemoved(IClient c) {
        ClientManagerListener[] listeners = (ClientManagerListener[]) listenerList
                .getListeners(ClientManagerListener.class);
     ...
     */
    public final Connection createClientConnection(Client client,
            ConnectionListener listener, boolean isServer) {
        try {
            return new Connection(client, listener, isServer, taskManager,
                    clientConnectionManager, this, clientTaskFactory);
    ...
    private class MyClientListener extends ClientListenerBase {
        ...
        public void connectionRequested(Client client, boolean isServer,
            ...
            client.setConnection(createClientConnection(client, listener,
                    isServer));
...
/*******************************************************************************
 * $Log: ClientManager.java,v $
 * Revision 1.19  2005/10/02 11:42:28  timowest
 * updated sources and tests
 * Revision 1.18 2005/09/30 15:59:53 timowest
 * updated sources and tests
 * 
 * Revision 1.17 2005/09/25 16:40:59 timowest updated sources and tests
 * 
