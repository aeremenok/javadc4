...
/**
 * <code>AbstractShareManager</code> represents an abstract base
 * implementation for the <code>IShareManager</code> interface mainly used to
 * separate the listener notification code from the main implementation
 * 
 * @author Timo Westk�mper
 */
public abstract class AbstractShareManager extends GenericModel implements
        IShareManager {
     ...
     */
    public final void fireDirectoryAdded(String dir) {
        ShareManagerListener[] l = (ShareManagerListener[]) listenerList
                .getListeners(ShareManagerListener.class);
     ...
     */
    public final void fireFileHashed(String filename) {
        ShareManagerListener[] l = (ShareManagerListener[]) listenerList
                .getListeners(ShareManagerListener.class);
     ...
     *      double)
     */
    public final void fireHashingFile(String filename, double percent) {
        ShareManagerListener[] l = (ShareManagerListener[]) listenerList
                .getListeners(ShareManagerListener.class);
...
/*******************************************************************************
 * $Log: AbstractShareManager.java,v $
 * Revision 1.12  2005/10/02 11:42:27  timowest
 * updated sources and tests
 * Revision 1.11 2005/09/12 21:12:02
