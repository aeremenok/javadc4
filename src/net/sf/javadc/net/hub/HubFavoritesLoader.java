...
/**
 * <code>HubFavoritesLoader</code> represents a helper class of the
 * <code>HubFavoritesList</code> used to serialize and deserialize the
 * information about the application users' favorite hubs.
 * 
 * @author Timo Westk�mper
 */
public class HubFavoritesLoader implements IHubFavoritesLoader {

    private static final Category logger = Category
            .getInstance(HubFavoritesLoader.class);
    ...
    /**
     * Create a HubFavoritesLoader instance which uses the default location of
    ...
    /**
     * Create a HubFavoritesLoader instance which uses the given file location
     * to retrieve the configuration file
     * 
     * @param _configFileName
     *            configuration file location to be used
     */
    public HubFavoritesLoader(String _configFileName) {
    ...
    public final List load() {
        ...
        try {
            ...
            logger.error("Catched " + e.getClass().getName()
                    + " when trying to load favorite Hubs.");
            logger.error(e);
     ...
     */
    public final void save(List hubInfos) {
        // serialize hub infos
        try {
            ...
            logger.error("Catched " + e.getClass().getName()
                    + " when trying to save favorite Hubs.");
            logger.error(e);
...
/*******************************************************************************
 * $Log: HubFavoritesLoader.java,v $
 * Revision 1.13  2005/10/02 11:42:28  timowest
 * updated sources and tests
 * Revision 1.12 2005/09/30 15:59:53 timowest
 * updated sources and tests
 * 
