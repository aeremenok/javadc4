...
/**
 * Defines constraints for each component added to container with HIGLayout
 * layout manager. Defines components target area: x, y (column, row) of top
 * left corner, width (number of columns or absolute size in pixels), height
 * (number of rows or absolute size in pixels), anchors string, vertical and
 * horizontal corrections. Usually You will use one instance of this class
 * because HIGLayout copies passed constraint object when adds component to
 * container.
 * <P>
 * Most of methods returns <em>this</em> object so Your can chain more calls
 * into single line of code.
 * </P>
 * 
...
public class HIGConstraints implements java.io.Serializable {
     ...
     * takes component's preferred size it will add to it passed width
     * correction; after positioning it will change position about position
     * correction.
     * 
     * @param xCorr
     *            correction of horizontal position, in pixels. Can be negative.
     * @param wCorr
     ...
     * takes component's preferred size it will add to it passed height
     * correction; after positioning it will change position about position
     * correction.
     * 
     * @param yCorr
     *            correction of vertical position, in pixels. Can be negative.
     * @param hCorr
    ...
    /**
     * Sets column index. Preserves row index, sets anchor to "rltb", width and
     * height to 1.
     * 
     * @param x
     *            column index
    ...
    /**
     * Sets column index and anchors. Preserves row index, sets width and height
     * to 1.
     * 
     * @param x
     *            column index
    ...
    /**
     * Sets column index, target area width and height. Preserves row index,
     * sets anchors string to "lrtb".
     * 
     * @param x
     *            column index
     * @param w
    ...
    /**
     * Sets column index, target area width, height and anchors. Preserver row
     * index.
     * 
     * @param x
     *            column index
    ...
    /**
     * Sets row index. Preserves column index, sets anchor to "rltb", width and
     * height to 1.
     * 
     * @param y
     *            row index
    ...
    /**
     * Sets row index and anchors. Preserves column index, width and height to
     * 1.
     * 
     * @param y
     *            row index
    ...
    /**
     * Sets row index, target area width and height. Preserves row index, sets
     * anchors string to "lrtb".
     * 
     * @param y
     *            row index
     * @param w
    ...
    /**
     * Sets row index, target area width, height and anchors. Preserver column
     * index.
     * 
     * @param y
     *            row index
