/*
 * HIGConstraints.java - HIGLayout layout manager Copyright (C) 1999 Daniel Michalik This library is free software; you
 * can redistribute it and/or modify it under the terms of the GNU Lesser General Public License as published by the
 * Free Software Foundation; either version 2 of the License, or (at your option ) any later version. This library is
...
/**
 * Defines constraints for each component added to container with HIGLayout layout manager. Defines components target
 * area: x, y (column, row) of top left corner, width (number of columns or absolute size in pixels), height (number of
 * rows or absolute size in pixels), anchors string, vertical and horizontal corrections. Usually You will use one
 * instance of this class because HIGLayout copies passed constraint object when adds component to container.
 * <P>
 * Most of methods returns <em>this</em> object so Your can chain more calls into single line of code.
 * </P>
 * 
        ...
        java.io.Serializable
{
     ...
     *  
     */
    private static final long   serialVersionUID = -8122273607485544964L;
    ...
    int                         w                = 1;                    /*
                                                                                                                                                * when >0, means width in cells; < 0, means fixed width in
                                                                                                                                                * pixels
                                                                                                                                                */
    ...
    /**
     * Set horizontal correction until changed or cleared. When layout manager takes component's preferred size it will
     * add to it passed width correction; after positioning it will change position about position correction.
     * 
     ...
     * @return this
     */
    public HIGConstraints setHCorrection(
        int xCorr,
        int wCorr )
    {
        xCorrection = xCorr;
    ...
    /**
     * Set vertical correction until changed or cleared. When layout manager takes component's preferred size it will
     * add to it passed height correction; after positioning it will change position about position correction.
     * 
     ...
     * @return this
     */
    public HIGConstraints setVCorrection(
        int yCorr,
        int hCorr )
    {
        yCorrection = yCorr;
