/*
 * HIGDemoPanel.java Copyright (C) 1999 Daniel Michalik This library is free software; you can redistribute it and/or
 * modify it under the terms of the GNU Lesser General Public License as published by the Free Software Foundation;
 * either version 2 of the License, or (at your option ) any later version. This library is distributed in the hope that
...
/**
 * Extended Swing's JPanel with added paint functionality. Draws design grid of the panel.
 * 
 * @version 1.0 1/19/2002
 * @author Daniel Michalik (dmi@autel.cz)
 */
public class HIGDemoPanel
    extends JPanel
{
