...
/**
 * This class is highly influenced by a Huffman encoder/decoder written by Ville Luolajan-Mikkola
...
public class He3
{
        ...
        throws IOException
    {
        ...
        {
            // read the header
            if ( buffin.read() != 'H' || buffin.read() != 'E' || buffin.read() != '3' )
            {
...
/*******************************************************************************
 * $Log: He3.java,v $ Revision 1.10 2005/10/02 11:42:28 timowest updated sources and tests Revision 1.9 2005/09/14
