...
/**
 * <code>FileInfo</code> represents minimal information on a single file
 * shared via the <code>ShareManager</code> instance
 * 
...
public class FileInfo implements Serializable {
    ...
    /**
     * Constructs a <CODE>FileInfo</CODE> object with the given absolute path,
     * file name and file size
     */
    public FileInfo(String _absolutePath, String _name, long _length) {
        this();
     ...
     *            The hash to set.
     */
    public void setHash(HashInfo hash) {
        if (hash == null)
 ...
 * Revision 1.7 2005/09/26 17:19:52 timowest updated
 * sources and tests
 * 
 * Revision 1.6 2005/09/14 07:11:48 timowest updated sources
 * 
 * 
 * 
 */
