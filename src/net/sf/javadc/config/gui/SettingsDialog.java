...
/**
 * <CODE>SettingsDialog</CODE> is the main dialog for editing the application
 * settings of javadc3
 * 
...
public class SettingsDialog extends JDialog {
    ...
    private final static Category logger = Category
            .getInstance(SettingsDialog.class);
    ...
    /**
     * Create a SettingsDialog instance with the given container frame, title,
     * modal settings and references to the ISettings and ShareManager
     * components
     * 
     * @param owner
     *            container Frame instance
     * @param title
     *            Title of the dialog
     * @param modal
     ...
     * @param _shareManager
     *            IShareManager to be used
     */
    public SettingsDialog(Frame owner, String title, boolean modal,
            ISettings _settings, IShareManager _shareManager) {
        ...
        transferSettingsPanel = new TransferSettingsPanel(settings,
                shareManager);
