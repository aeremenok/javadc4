...
/**
 * <CODE>SettingsLoader</CODE> loads the core application settings from XML
 * when the application containers are started and saves the settings back to
 * XML when the application is closed
 */
public class SettingsLoader implements ISettingsLoader {

    /**
     * Factory method implementation to create instance of Settings, if the XML
     * serialized representation is not available
     */
    private final SettingsFactory settingsFactory = new SettingsFactory();

    static private final Category logger = Category
            .getInstance(SettingsLoader.class);
    ...
    /**
     * Create a SettingsLoader instance which reads the Settings from the
     * default location
     */
    ...
    /**
     * Create a SettingsLoader instance which reads the Settings information
     * from the given file location
     * 
     * @param settingsFileName
     */
    public SettingsLoader(String _configFileName) {
...
/*******************************************************************************
 * $Log: SettingsLoader.java,v $
 * Revision 1.16  2005/10/02 11:42:27  timowest
 * updated sources and tests
 * Revision 1.15 2005/09/30 15:59:52 timowest
 * updated sources and tests
 * 
 * Revision 1.14 2005/09/14 07:11:48 timowest updated sources
 * 
 * 
 * 
 */
