...
/**
 * <code>ConnectionListener</code> is the listener interface for objects interested in notifications from
        ...
        EventListener
{
     ...
     * 
     * @param connection Connection which has been canceled
     */
    void disconnected(
     ...
     * 
     * @param connection Connection for which a download has completed
     */
     ...
     * 
     * @param connection Connection for which a download has failed
     */
    void downloadFailed(
        IConnection connection );
     ...
     * 
     * @param connection Connection whose state has changed
     */
    void stateChanged(
        IConnection connection );
     ...
     * 
     * @param connection Connection for which an upload has completed
     */
    void uploadComplete(
        IConnection connection );
     ...
     * 
     * @param connection Connection for which an upload has failed
     */
    void uploadFailed(
        IConnection connection );
}