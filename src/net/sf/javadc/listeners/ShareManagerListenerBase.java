...
/**
 * <code>ShareManagerListenerBase</code> is the default implementation of the
 * <code>ShareManagerListener</code> interface. It can be used as the super
 * class for implementations which are only interested in few notifications.
 * 
 * @author Timo Westk�mper
 */
public class ShareManagerListenerBase implements ShareManagerListener {
