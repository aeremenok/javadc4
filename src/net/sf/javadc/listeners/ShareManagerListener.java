...
/**
 * <code>ShareManagerListener</code> is the listener interface for objects
 * interested in notifications from <code>ShareManager</code> instances
 * 
 * @author Timo Westk�mper
 */
public interface ShareManagerListener extends EventListener {

    /**
     * The directory with the given path has been added to the set of shared
     * files
     * 
     * @param directory
     *            filename of the directory which has been added
     */
     ...
     * 
     * @param filename
     *            filename of the file which is being hashed
     * @param percent
     *            state of the hashing process
     */
