...
/**
 * <CODE>IHubList</CODE> is the abstract interface of <CODE>HubList</CODE>,
 * which provides a list of <CODE>Hubs</CODE>, the application can connect to
 * 
 * @author tw70794
 */
public interface IHubList extends IObject {
