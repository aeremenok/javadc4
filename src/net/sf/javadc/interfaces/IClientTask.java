...
/**
 * <CODE>IClientTask</CODE> represents the abstract interface implemented by
 * the different task handler implementations of the Client <CODE>Connection</CODE>
 * 
 * @author tw70794
 */
public interface IClientTask extends ITask {
    ...
    /**
     * Return a list of Exceptions which have been thrown in this IClientTask
     * instance
     * 
     * @return
     */
