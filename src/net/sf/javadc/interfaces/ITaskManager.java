...
/**
 * <CODE>ITaskManager</CODE> is the abstract interface for <CODE>TaskManager</CODE>,
 * which provides a way to execute actions in asynchronous manner
 * 
 * @author tw70794
 */
public interface ITaskManager extends ITask, Runnable {
     ...
     * @param task
     */
    public abstract void addEvent(ITask task);
