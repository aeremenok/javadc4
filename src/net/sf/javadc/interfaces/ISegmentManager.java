        ...
        IObject
{
     ...
     * 
     * @param dr
     * @return the segmented DownloadRequest or null, if the all segments are being used or the given DownloadRequest is
     *         already segmented
     */
    public abstract DownloadRequest getNextSegment(
        DownloadRequest dr );
