...
/**
 * <CODE>ITask</CODE> represents the abstract interface that is to be
 * implemented for tasks and events to be run in asynchronous manner via the
 * <CODE>TaskManager</CODE>
 * 
 * @author Jesper Nordenberg
 * @version $Revision: 1.9 $ $Date: 2005/10/02 11:42:27 $
 */
public interface ITask extends IObject {
