...
/**
 * <CODE>IShareManager</CODE> is the abstract interface for <CODE>ShareManager</CODE>, which manages the creation of
 * file lists based on the shared files and the handling of <CODE>SearchRequests</CODE>
 * 
 * @author tw70794
 */
        ...
        IGenericModel
{
    ...
    /**
     * Notify registered listeners that the given directory has been added to the list of shared files
     * 
     * @param dir
     */
    public void fireDirectoryAdded(
        String dir );
