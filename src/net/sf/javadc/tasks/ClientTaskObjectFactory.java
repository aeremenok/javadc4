...
/**
 * <code>ClientTaskObjectFactory</code> is a simple Jakarta Commons Pool and PicoContainer based Factory method
 * implementation used via the <code>ClientTaskFactory</code>.
 * 
 * @author Timo Westk�mper
 */
public class ClientTaskObjectFactory
    extends BaseKeyedPoolableObjectFactory
{
    private final static Category      logger = Category.getInstance( ClientTaskObjectFactory.class );
    ...
    /**
     * Create a ClientTaskObjectFactory instance which creates ClientTask instances via the given PicoContainer
     * tasksContainer
     * 
     * @param tasksContainer PicoContainer used to create preconfigured instances of client tasks
     */
    public ClientTaskObjectFactory(
        ...
        throws Exception
    {
        ...
        {
            Class aclass =
                Class.forName( ConstantSettings.CLIENTTASKFACTORY_PREFIX + taskName +
                    ConstantSettings.CLIENTTASKFACTORY_POSTFIX );

            // retrieve component adapter related to the specific component type
            final ComponentAdapter adapter = (ComponentAdapter) componentAdapters.get( aclass );
