 ...
 * 
 * <p>
 * $SR fromuser path\to\file.ext\0x5filesize freeslots/openslots\0x5hubname
 * (hubaddress[:port])\0x5touser|
 * </P>
 * 
 * <p>
 ...
 * 
 * <p>
 * fromuser has found a file that matches touser's search.<br/> '\0x5' is the
 * byte valued 5, it is used as a separator, space ' ' is also used as a
 * separator at times<br/> freeslots and openslots are the attributes of the
 * client (in text)<br/> the hupipaddress are how the client connected to the
 * hub
 * </p>
 * 
 * <p>
 * example:<br/> $SR User1 mypath\motd.txt5437 3/45Testhub
 * (10.10.10.10:411)5User2| (the bold fives are ascii #5)
 * </p>
 * 
 * @author tw70794
 */
public class ISRTask extends BaseHubTask {
     ...
     * @param _settings
     */
    public ISRTask(ISettings _settings) {
