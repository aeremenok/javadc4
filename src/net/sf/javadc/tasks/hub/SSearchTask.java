 ...
 */
public class SSearchTask extends BaseHubTask {

    private static final Category logger = Category
            .getInstance(SSearchTask.class);
     ...
     * @param settings
     */
    public SSearchTask(ISettings settings) {
    ...
    protected void runTaskTemplate() {
        ...
        if (settings.isActive()) {
            ...
            sendCommand("$Search", settings.getIP() + ":" + dataPort + " "
                    + cmdData);
