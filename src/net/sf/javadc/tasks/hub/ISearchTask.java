 ...
 * 
 * <p>
 * &lt;ip&gt; is this client's IP address.<br/> &lt;port&gt; is a UDP port on
 * which the client is listening for responses.
 * </p>
 * 
 * <p>
 ...
 * 
 * <p>
 * &lt;searchstring&gt; is a string describing the file the client is searching
 * for it is made up of:
 * </p>
 * 
 * <p>
 * &lt;sizerestricted&gt;?&lt;isminimumsize&gt;?&lt;size&gt;?&lt;datatype&gt;?&lt;searchpattern&gt;<br/>
 * &lt;sizerestricted&gt; is 'T' if the search should be restricted to files of
 * a minimum or maximum size, otherwise 'F'.<br/> &lt;isminimumsize&gt; is 'F'
 * if &lt;sizerestricted&gt; is 'F' or if the size restriction<br/> places an
 * upper limit on file size, otherwise 'T'.<br/> &lt;size&gt; is the minimum or
 * maximum size of the file to report (according to &lt;isminimumsize&gt;) if
 * &lt;sizerestricted&gt; is 'T', otherwise 0.<br/> &lt;datatype&gt; restricts
 * the search to files of a particular type. It is an integer selected from:
 * </p>
 * 
 * <ul>
 * <li>1 for any file type</li>
 * <li>2 for audio files ("mp3", "mp2", "wav", "au", "rm", "mid", "sm")</li>
 * <li>3 for compressed files ("zip", "arj", "rar", "lzh", "gz", "z", "arc",
 * "pak")</li>
 ...
 * Every other user with one or more matching files must send a UDP packet to
 * &lt;ip&gt;:&lt;port&gt; for Active requests or a reply to the Hub for Passive
 * requests.
 * </p>
 * 
 * <p>
 ...
 * @author tw70794
 */
public class ISearchTask extends BaseHubTask {

    private static final Category logger = Category
            .getInstance(ISearchTask.class);
     ...
     * @param shareManager
     */
    public ISearchTask(ISettings settings, IShareManager shareManager,
     ...
     * 
     * @param sr
     *            SearchRequest which was the basis for the search
     * @param resulta
     *            SearchResults obtained via the ShareManager
     */
    private final void postResults(SearchRequest sr, SearchResult[] resulta) {

        PerformanceContext cont = new PerformanceContext(
                "ISearchTask#postResults(SearchRequest, SearchResult[])")
                .start();
        ...
        if (sr.activeMode()) {
            for (int i = 0; i < resulta.length; i++) {
                ...
                UDPUtils.sendUDPString("$SR " + nick + " "
                        + resulta[i].getSearchResponse(hub), sr
                        .getRespondAddress());
            ...
            for (int i = 0; i < resulta.length; i++) {
                ...
                sendCommand("$SR", nick + " "
                        + resulta[i].getSearchResponse(hub) + (char) 5
