...
/**
 * $MaxedOut is the command you would send to a client that wishes to download something from you, but you have no free
 * slots.
 * 
 * @author tw70794
 */
public class IMaxedOutTask
    extends BaseClientTask
{

    // private static int DELAY_TIME = 120 * 1000;
    private static final Category logger = Category.getInstance( IMaxedOutTask.class );
    ...
    protected final void runTaskTemplate()
    {
        ...
        try
        {
            output.append( "from " ).append( clientConnection.getClient().getNick() );
