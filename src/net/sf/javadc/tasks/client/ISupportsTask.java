 ...
 * certain client supports. This should be the name of the command being sent, i
 * e if a client supports a command "$GetBZListLen|", featurename should be
 * GetBZListLen, unless of course, this is not a feature that requires sending
 * extra data. Feature names may (obviously) not contain spaces. Empty $Supports
 * should not be sent.
 * </p>
 * 
 * @author tw70794
 */
public class ISupportsTask extends BaseClientTask {
