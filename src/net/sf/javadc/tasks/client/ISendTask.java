...
/**
 * Sent by the downloading client in response to a $FileLength command. Requests the uploader to begin uploading the
 * file.
 * 
 * @author tw70794
 */
public class ISendTask
    extends BaseClientTask
{

    private static final Category logger = Category.getInstance( ISendTask.class );
