...
/**
 * <CODE>AbstractFileListModel</CODE> is an abstract super class for the
 * <CODE>FileListModel</CODE>, which provides the main methods use in the
 * Observer / Observable design pattern
 * 
 * @author Timo Westk�mper
 */
public abstract class AbstractFileListModel extends GenericModel {
    ...
    private FileListModelListener[] getFileListModelListeners() {
        ...
        return (FileListModelListener[]) listenerList
                .getListeners(FileListModelListener.class);
    }
    ...
    public void fireTreeNodesInserted(Object source, Object[] path,
        ...
        for (int i = 0; i < listeners.length; i++) {
            listeners[i]
                    .treeNodesInserted(source, path, childIndices, children);
        }
    ...
    public void fireTreeStructureChanged(Object source, Object[] path,
        ...
        for (int i = 0; i < listeners.length; i++) {
            listeners[i].treeStructureChanged(source, path, childIndices,
                    children);
        }
...
/*******************************************************************************
 * $Log: AbstractFileListModel.java,v $
 * Revision 1.10  2005/10/02 11:42:28  timowest
 * updated sources and tests
 * Revision 1.9 2005/09/14 07:11:49
