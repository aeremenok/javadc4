...
public class TableSorter extends TableMap {
     ...
     * 
     * @param readOnly
     *            whether the Table is a readonly table
     */
    public TableSorter(boolean readOnly) {
     ...
     * 
     * @param model
     *            TableModel to be used
     * @param readOnly
     *            whether the Table is a readonly table
     */
    public TableSorter(TableModel model, boolean readOnly) {
        setModel(model);
        this.readOnly = readOnly;
     ...
     * @return
     */
    public final boolean rowBefore(int row1, int row2) {
        if (ascending) {
     ...
     * @return
     */
    public final int compareRows(int row1, int row2) {
     ...
     * @return
     */
    public final int compareRows(int row1, int row2, int column) {
     ...
     * @param lastRow
     */
    private final void insertRows(int firstRow, int lastRow) {
        ...
        super.tableChanged(new TableModelEvent(this, minRow, maxRow,
     ...
     * @param lastRow
     */
    private final void deleteRows(int firstRow, int lastRow) {
        int minRow = Integer.MAX_VALUE;
        int maxRow = 0;
        int size = indexes.length;
        ...
        for (int row = firstRow; row <= lastRow; row++) {
            for (int i = 0; i < size; i++) {
                if (row == indexes[i]) {
                    System.arraycopy(indexes, i + 1, indexes, i, indexes.length
                            - i - 1);
 ...
 * Revision 1.12 2005/09/25 16:40:58 timowest updated
 * sources and tests
 * 
