...
/**
 * <CODE>UserCellRenderer</CODE> is an extension to the <CODE>DefaultTableCellRenderer</CODE>
 * which renders column contents of <CODE>HubUser</CODE>
 * 
 * @author Ryan Sweny
...
public class UserCellRenderer extends DefaultTableCellRenderer {
     ...
     *            List of operators
     */
    public UserCellRenderer(ImageIcon[] i, List a) {
        bufferedImages = i;
        opList = a;
    ...
    public final Component getTableCellRendererComponent(JTable table,
        ...
        String speed = ((String) table.getModel().getValueAt(row, 2))
                .toLowerCase();

        result.setHorizontalAlignment(JLabel.LEFT);

        RowTableModel model = (RowTableModel) ((TableSorter) table.getModel())
                .getModel();
