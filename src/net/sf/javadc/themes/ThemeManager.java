...
/**
 * Created by IntelliJ IDEA. User: interactif06 Date: 3-ago-2004 Time: 16.10.52
 * To change this template use File | Settings | File Templates.
 */
public class ThemeManager implements Startable {
    ...
    public void installLookAndFeels() {
        ...
        UIManager.installLookAndFeel("Extended Windows",
        ...
        List plasticThemes = new ArrayList(PlasticLookAndFeel
                .getInstalledThemes());
    ...
    public void initialize() {
        ...
        if (settings.getGuiSettings() == null) {
            guiSettings = GuiSettingsFactory
     ...
     * @return
     */
    public MetalTheme getThemeByName(String themeName) {
    ...
    public void setUIDefaults() {
        ...
        // Set font options
        UIManager.put(Options.USE_SYSTEM_FONTS_APP_KEY, settings
                .getGuiSettings().isUseSystemFonts());

        // TODO : fix it in GuiSettings (Problem : Serialization)

        Options.setGlobalFontSizeHints(FontSizeHints.MIXED);

        Options.setUseNarrowButtons(settings.getGuiSettings()
                .isUseNarrowButtons());

        // Global options
        Options.setTabIconsEnabled(settings.getGuiSettings()
                .isTabIconsEnabled());

        UIManager.put(Options.POPUP_DROP_SHADOW_ENABLED_KEY, settings
                .getGuiSettings().isPopupDropShadowEnabled());
     ...
     */
    public void configureUI(String lookAndFeelName) {
        ...
        for (int i = 0; i < lafs.length; i++) {
            ...
            if (laf.getName().equalsIgnoreCase(lookAndFeelName)) {
                ...
                if (laf.getClassName().indexOf("Plastic") != -1) {
                    PlasticLookAndFeel
                            .setMyCurrentTheme((PlasticTheme) getThemeByName(settings
                                    .getGuiSettings().getTheme()));
                    PlasticLookAndFeel.setTabStyle(settings.getGuiSettings()
                            .getPlasticTabStyle());
                    PlasticLookAndFeel
                            .setHighContrastFocusColorsEnabled(settings
                                    .getGuiSettings()
    ...
    public UIManager.LookAndFeelInfo[] getInstalledLookAndFeels() {
        ...
        return (UIManager.LookAndFeelInfo[]) lafs
                .toArray(new UIManager.LookAndFeelInfo[0]);
    ...
    public class ThemeComparator implements Comparator {
        ...
        public int compare(Object o1, Object o2) {
            return ((Theme) o1).getName().compareToIgnoreCase(
                    ((Theme) o2).getName());
    ...
    private static class MyTheme extends MetalThemeWrapper {

        public MyTheme(PlasticTheme theme) {
            super(theme);
...
/*******************************************************************************
 * $Log: ThemeManager.java,v $
 * Revision 1.12  2005/10/02 11:42:28  timowest
 * updated sources and tests
 * Revision 1.11 2005/09/14 07:11:50 timowest
 * updated sources
 * 
 * 
 * 
